  ...
  return (
    <header className="site-header">
      <a className="brand" href="#about" aria-label="Lakshmi Srikanth Polavarapu home" style={{ display: "inline-flex", alignItems: "center", gap: "10px" }}>
        <img src="/avatar-cisco-crop.png" alt="Lakshmi Srikanth Avatar" style={{ width: "36px", height: "36px", borderRadius: "50%", boxShadow: "0 0 12px rgba(147, 51, 234, 0.6)" }} />
      ...
      <nav className={open ? "nav-open" : ""}>
        ...
        <a href="/resume.pdf" target="_blank" rel="noreferrer" onClick={() => setOpen(false)} style={{ color: "#c084fc", fontWeight: 600 }}>Resume ↗</a>
      </nav>
    </header>
  );
};
